...
public class North_South_Car : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Check if the car's y position is beyond the bottom edge of the screen
    ...
    {
        if (collision.gameObject.CompareTag("North South Car"))
        {
            hitOtherCar = true;
